...
myfunction <- function(testingMethodString){
  ...
  # print(ggplot(roc.data, aes(x=fpr, ymin=0, ymax=tpr)) +
...
#_____________________________BELOW CODE IS FOR MULTIPLE REPLICATIONS IF NECESSARY______
# x <- numeric()
# for(t in 1:1000) {
#   x <- append(x, myfunction("P241"))
#   print(x)
# }
